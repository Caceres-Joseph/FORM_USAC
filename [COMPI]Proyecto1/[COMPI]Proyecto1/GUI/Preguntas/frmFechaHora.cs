...
{
    partial class frmFechaHora : Form
    {
        itemValorPregunta valor;

        public frmFechaHora(itemValorPregunta valor, elementoEntorno parametros)
        {
        ...
        */
        ...
        public void siguiente()
        {
            ...
            string theDate = dateTimePicker1.Value.ToString("dd/MM/yyyy hh:mm:ss");

            if (theDate == "")
                theDate = "10/10/2010 00:00:00";


            println("FechaHora seleccionada:" + theDate);
