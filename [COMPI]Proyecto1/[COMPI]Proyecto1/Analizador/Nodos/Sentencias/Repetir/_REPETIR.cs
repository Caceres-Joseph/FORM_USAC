...
namespace _COMPI_Proyecto1.Analizador.Nodos.Sentencias.Repetir
{
    class _REPETIR : nodoModelo
    /*
        REPETIR.Rule = tRepetir + sAbreLlave + LST_CUERPO + sCierraLlave + tHasta + sAbreParent + E + sCierraParent + sPuntoComa;

     */
    {
        public _REPETIR(string nombre, tablaSimbolos tabla) : base(nombre, tabla)
        {
        }
