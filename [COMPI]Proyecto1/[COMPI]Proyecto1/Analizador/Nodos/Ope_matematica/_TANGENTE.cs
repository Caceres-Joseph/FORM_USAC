...
namespace _COMPI_Proyecto1.Analizador.Nodos.Ope_matematica
{
    ...
    */
    {
        public _TANGENTE(string nombre, tablaSimbolos tabla) : base(nombre, tabla)
        {
        }
        ...
        */
        ...
        public override itemValor ope_tipo(elementoEntorno elem)
        {
            ...
            {
                retorno.setValue(Math.Tan(itemInicio.getDecimal()));
                return retorno;
            }
            else if (inicioTemp != null)
            {
                inicioVal = (int)inicioTemp;
                retorno.setValue(Math.Tan(inicioVal));
                return retorno;
            }
            else
            {
