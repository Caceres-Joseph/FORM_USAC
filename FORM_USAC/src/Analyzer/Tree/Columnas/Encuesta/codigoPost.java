 ...
 * @author joseph
 */
public class codigoPost extends etiqueta {
     ...
     * @param simbolo
     */
    public codigoPost(tablaSimbolos tablaSimbolos, elementoSimbolo simbolo) {
    ...
    public String getCadena() {
        ...
        cell celdaCalc = simbolo.lstAtributos.get("codigo_post");
        if (celdaCalc == null) {
            return retorno;
        }
